...
// Use forwardRef to allow the parent to get a reference to the internal play function
const AudioPlayer = forwardRef<AudioPlayerControls>((props, ref) => {
  ...
  useEffect(() => {
    ...
    audioLoader.load(getFullPath("/music/car-beat.mp3"), (buffer) => {
...
function BackgroundPoster() {
  const [texture] = useTexture([getFullPath("/sunset-seaside.jpg")])
  return (
    <mesh
...
export default function App() {
  ...
  const handleStartClick = () => {
    // 2. Set started to true on click
    setStarted(true)
  ...
  return (
    <main className="noise w-full overflow-x-auto">
      ...
      <Loader
        ...
        // barStyles={{ height: 6, borderRadius: "12px" }}
        // innerStyles={{ height: 6, borderRadius: "12px" }}
      ...
      <Canvas shadows camera={{ position: [0, 3, 34], fov: 45 }}>
        ...
        <Suspense fallback={null}>
          ...
          <BMWCar2 />
          <SelectEnv />
          <AudioPlayer ref={audioControlsRef} />
          {/* <AudioComponent /> */}
        </Suspense>
